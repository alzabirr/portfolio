                ...
                <div className="flex flex-col justify-center">
                  ...
                  {project["tech-stack"] && (
                    <div className="mt-2 text-left">
                      <span className="text-xs text-gray-500 font-semibold block mb-1"> Tech Stack</span>
                      <div className="flex flex-wrap gap-2">
                        {project["tech-stack"].map((tech) => {
                          const Icon = iconMap[tech.toLowerCase()];
                          return Icon ? (
                            <div key={tech} className="bg-gray-100 p-1.5 rounded-md text-gray-700 hover:text-black transition-colors duration-200" title={tech}>
                              <Icon size={18} />
                            </div>
                          ) : (
